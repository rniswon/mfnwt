...
C6------CALCULATE ETDEMAND IF NOT SUPPLEMENTAL WELL.
            IF ( ETDEMANDFLAG > 0 ) Q = demandgw(l)
          END IF
C
...
C         AND DIVERTED SW.  
     ...
     1                    DVT*(DONE-DVEFF(ICOUNT,istsg))/AREA
...
300   continue
      return
      end subroutine demandconjunctive
C
