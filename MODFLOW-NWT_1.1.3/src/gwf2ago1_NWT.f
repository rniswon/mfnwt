...
! from well package
        ...
        INTEGER,SAVE,POINTER  :: IWELCB,IRDPSI,IWELPB,NNPWEL,NAUX
...
!      CHARACTER(len=16) :: text        = ' AGO PACKAGE '
      ...
      INTEGER :: NUMTABHOLD,MXACTW,LLOC,ISTART,ISTOP,I,N
      REAL :: R
C     ------------------------------------------------------------------
...
C5------READ AUXILIARY VARIABLES AND PRINT FLAG.
   ...
   12       FORMAT(1X,'AUXILIARY WELL VARIABLE: ',A)
      ...
      ELSE IF(LINE(ISTART:ISTOP).EQ.'NOPRINT') THEN
         WRITE(IOUT,13)
   13    FORMAT(1X,'LISTS OF AGO WELL CELLS WILL NOT BE PRINTED')
         IPRWEL = 0
         GO TO 10
      END IF
C
