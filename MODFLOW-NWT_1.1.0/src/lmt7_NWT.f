...
C--USE FILE SPECIFICATION of MODFLOW-2005
     ...
     &              MTSWR,MTUSR1,MTUSR2,MTUSR3,MTUSR4,MTUSR5,MTUSR6,
     &              MTUSR7,MTUSR8,MTUSR9
     &             /32*0/
C     -----------------------------------------------------------------    
...
C
C--WRITE A HEADER TO MODFLOW-MT3DMS LINK FILE.  IF SWR IS ACTIVE
C--THEN USE A NEW VERSION NUMBER
     ...
     &     MTSWT,MTSFR,MTUZF
          ELSE
           WRITE(IUMT3D) 'MT3D6.00.00',
     &     MTWEL,MTDRN,MTRCH,MTEVT,MTRIV,MTGHB,MTCHD,MTISS,MTNPER,
     &     MTSTR,MTRES,MTFHB,MTDRT,MTETS,MTSUB,MTIBS,MTLAK,MTMNW,
     &     MTSWT,MTSFR,MTUZF,MTSWR,MTUSR1,MTUSR2,MTUSR3,MTUSR4,
     &     MTUSR5,MTUSR6,MTUSR7,MTUSR8,MTUSR9
          ENDIF
        ELSEIF(ILMTFMT.EQ.1) THEN
          IF(MTSWR.EQ.0) THEN
           WRITE(IUMT3D,*) 'MT3D4.00.00',
...
C ******************************************************************
      ...
      USE GWFSWRMODULE,ONLY:NQAQCONN,REACH,NREACHES
      IMPLICIT NONE
