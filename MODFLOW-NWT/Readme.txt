...
MODFLOW-NWT version 1.1.5 is packaged for personal computers using one of the 
...
Version 19.0.0052.15. The source code is provided to aid users in compilation 
...
Included in directory MODFLOW-NWT_1.1.5\doc is the MODFLOW-NWT documentation 
...
directory, the directory containing the executables (MODFLOW-NWT_1.1.5\bin)
should be included in the PATH environment variable.  

As an alternative, the executable files, MODFLOW-NWT.exe and MODFLOW-NWT_64.exe, 
in the MODFLOW-NWT_1.1.5\bin directory can be copied into a directory already
included in the PATH environment variable.


C. EXECUTING THE SOFTWARE

A 32 bit and a 64 bit executable are provided in the MODFLOW-NWT_1.1.5\bin  
...
After the executable files in the MODFLOW-NWT_1.1.5\bin directory are installed in
...
The executable files are provided in MODFLOW-NWT_1.1.5\bin. Although executable versions   
of the program are provided, the source code also is provided in the MODFLOW-NWT_1.1.5\src 
